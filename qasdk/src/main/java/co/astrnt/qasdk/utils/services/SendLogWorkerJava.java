...
public class SendLogWorkerJava extends Worker {
    ...
    public SendLogWorkerJava(@NonNull @NotNull Context context,
    ...
    private void onCreateExecution() {
        ...
        mTimer.scheduleAtFixedRate(new SendLogWorkerJava.TimeDisplayTimerTask(), 5000, NOTIFY_INTERVAL);
    }
    ...
    class TimeDisplayTimerTask extends TimerTask {
        ...
        @Override
        public void run() {
            mHandler.post(SendLogWorkerJava.this::doSendLog);
        }
    }
